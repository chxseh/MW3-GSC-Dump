...
main( model, type, classname )
{
	...
	build_light( lightmodel, "white_blink", 				"tag_light_belly", 		"misc/aircraft_light_white_blink", 		"running", 	0.15 );
	build_light( lightmodel, "wingtip_green1", 			"tag_light_L_wing1", 	"misc/aircraft_light_wingtip_green", 	"running", 	0.3 );
	build_light( lightmodel, "wingtip_red1", 			"tag_light_R_wing1", 	"misc/aircraft_light_wingtip_red", 		"running", 	0.2 );
	build_light( lightmodel, "solid_tail", 				"tag_light_tail2", 		"misc/aircraft_light_wingtip_red", 		"running", 	0.25 );
	build_light( lightmodel, "white_blink_tail", 		"tag_light_tail", 		"misc/aircraft_light_red_blink", 		"running", 	0.05 );
