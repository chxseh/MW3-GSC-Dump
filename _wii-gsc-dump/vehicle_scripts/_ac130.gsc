...
level.ac130_HudTargetSize = 30;
level.ac130_HudTargetScreenEdgeClampBufferLeft = 0;
level.ac130_HudTargetScreenEdgeClampBufferRight = 0;
level.ac130_HudTargetScreenEdgeClampBufferTop = 0;
level.ac130_HudTargetScreenEdgeClampBufferBottom = 0;
level.ac130_default_HudTargetSize = 50;
level.ac130_default_HudTargetScreenEdgeClampBufferLeft = 120;
level.ac130_default_HudTargetScreenEdgeClampBufferRight = 126;
level.ac130_default_HudTargetScreenEdgeClampBufferTop = 139;
level.ac130_default_HudTargetScreenEdgeClampBufferBottom = 134;
...
level.ac130_current_fov = ( start_fov + _delta_fov );
...
if ( using_wii() )
level.player wii_NotifyOnCommand( "LISTEN_ac130_change_weapons", "weapnext", "weapnext", "+actionslot 4" );
else
...
level notify( "FLAG_ac130_changed_weapons" );
wait 0.1;
}
}
monitor_25mm_sound()
...
level.current_shell_shock = level.ac130_enhanced_shock;
...
level.ac130player thread play_sound_on_entity( "ui_ac130_view_switch" );
hud_off();
...
if ( using_wii() )
level.player wii_NotifyOnCommand( "LISTEN_switch_weapons", "weapnext", "weapnext", "+actionslot 4" );
else
