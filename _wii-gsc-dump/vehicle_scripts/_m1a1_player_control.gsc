...
foreach ( ai in ai )
{
if ( DistanceSquared( ai.origin, position ) < 1000000 )
return true;
}
return false;
}
...
if( ent_flag_exist( "fired_smoke_screen" ) )
...
thread maps\_minigun_viewmodel::player_viewhands_minigun( self.turret_mini, "viewhands_player_delta" );
...
level._effect[ "abrams_player_damage" ] = LoadFX( "fire/tank_fire_turret_abrams" );
player_anims();
