...
build_deathmodel( "vehicle_bm21_mobile_cover_pc", "vehicle_bm21_mobile_cover_dstry_pc" );
...
build_light( lightmodel, "headlight_truck_left", "tag_headlight_left", "misc/lighthaze", "headlights" );
build_light( lightmodel, "headlight_truck_right", "tag_headlight_right", "misc/lighthaze", "headlights" );
...
build_light( lightmodel, "parkinglight_truck_left_f", "tag_parkinglight_left_f", "misc/car_parkinglight_bm21", "headlights" );
build_light( lightmodel, "parkinglight_truck_right_f", "tag_parkinglight_right_f", "misc/car_parkinglight_bm21", "headlights" );
build_light( lightmodel, "taillight_truck_right", "tag_taillight_right", "misc/car_taillight_bm21", "headlights" );
build_light( lightmodel, "taillight_truck_left", "tag_taillight_left", "misc/car_taillight_bm21", "headlights" );
build_light( lightmodel, "brakelight_troops_right", "tag_taillight_right", "misc/car_taillight_bm21", "brakelights" );
build_light( lightmodel, "brakelight_troops_left", "tag_taillight_left", "misc/car_taillight_bm21", "brakelights" );
