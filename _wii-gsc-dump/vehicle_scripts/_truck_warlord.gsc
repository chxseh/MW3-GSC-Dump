...
positions[ 2 ].idle = %africa_technical_passenger_rside_idle;
positions[ 3 ].idle = %africa_technical_passenger_lside_idle;
positions[ 4 ].idle = %africa_technical_passenger_back_idle;
