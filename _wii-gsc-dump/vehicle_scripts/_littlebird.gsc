...
build_deathmodel( "vehicle_little_bird_armed_so" );
build_deathmodel( "vehicle_little_bird_armed_streamed" );
...
build_deathfx( "explosions/helicopter_explosion_secondary_small",	"tag_engine", undefined, undefined, undefined, undefined, 2.5, true );
...
build_rocket_deathfx( "explosions/helicopter_explosion_little_bird_dcburn", "tag_deathfx", "littlebird_helicopter_crash",undefined, undefined, undefined, undefined, true, undefined, 0 );
...
build_light( lightmodel, "red_blink1", "TAG_LIGHT_TAIL1", "misc/aircraft_light_red_blink_occ", "running", randomStartDelay );
build_light( lightmodel, "red_blink2", "TAG_LIGHT_TAIL2", "misc/aircraft_light_red_blink_occ", "running", randomStartDelay );
...
if(classname != "script_vehicle_littlebird_bench_paris_a")
{
