...
main()
{
	self setModel("mp_body_russian_military_smg_a_airborne_wii");
...
precache()
{
	precacheModel("mp_body_russian_military_smg_a_airborne_wii");
...
{
	models = [];
	models[models.size]="mp_body_russian_military_smg_a_airborne_wii";
