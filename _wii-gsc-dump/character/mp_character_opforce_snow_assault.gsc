...
main()
{
	self setModel("mp_body_russian_military_assault_a_snow_wii");
...
precache()
{
	precacheModel("mp_body_russian_military_assault_a_snow_wii");
...
{
	models = [];
	models[models.size]="mp_body_russian_military_assault_a_snow_wii";
