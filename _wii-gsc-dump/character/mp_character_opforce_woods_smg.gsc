...
main()
{
	self setModel("mp_body_russian_military_smg_a_woods_wii");
...
precache()
{
	precacheModel("mp_body_russian_military_smg_a_woods_wii");
...
{
	models = [];
	models[models.size]="mp_body_russian_military_smg_a_woods_wii";
