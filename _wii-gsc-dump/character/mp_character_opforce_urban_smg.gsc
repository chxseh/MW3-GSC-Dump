...
main()
{
	self setModel("mp_body_russian_military_smg_a_urban_wii");
...
precache()
{
	precacheModel("mp_body_russian_military_smg_a_urban_wii");
...
{
	models = [];
	models[models.size]="mp_body_russian_military_smg_a_urban_wii";
