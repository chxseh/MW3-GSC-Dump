...
{
level.ai_resistance_leader dialogue_queue( "presc_rl_price" );
flag_wait( "leader_escape_dialogue02" );
level.ai_resistance_leader dialogue_queue( "presc_rl_havetogo" );
flag_wait( "leader_escape_dialogue03" );
level.ai_resistance_leader dialogue_queue( "presc_rl_thisway" );
flag_wait( "leader_escape_dialogue04" );
level.ai_resistance_leader dialogue_queue( "presc_rl_now" );
}
no_sound_bullets()
{
...
m_player_rig Delete();
level.m_escape_door Delete();
level.m_link_pistol Delete();
}
bottles_on_counter()
{
...
level.price dialogue_queue( "presc_pri_yuriopenit" );
}
