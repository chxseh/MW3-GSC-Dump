...
PreCacheModel( "vehicle_mig29_low_pc" );
if( is_split_level_part_or_original( "b" ) )
{
PreCacheModel( "vehicle_blackhawk_crash_pc" );
}
if( is_split_level_part_or_original( "a" ) )
{
PreCacheModel( "vehicle_v22_osprey_pc" );
}
if( is_split_level_part_or_original( "b" ) )
{
...
if( is_split_level_part_or_original( "b" ) )
{
PreCacheModel( "vehicle_hummer_pc" );
}
PreCacheModel( "vehicle_mi17_woodland_fly_pc" );
PreCacheModel( "weapon_m16" );
...
{
if ( damage > 990 )
level.mission_fail_points += level.max_mission_fail_points / 3;
else
if ( damage > 200 )
level.mission_fail_points += level.max_mission_fail_points / 7;
...
{
self ThermalDrawEnable();
self thread vehicle_scripts\_mig29::playConTrail();
...
{
self endon( "death" );
rumblestruct = level.vehicle_rumble[ "script_vehicle_mig29_low" ];
for ( ; ; )
{
if ( IsDefined( self.rumbletrigger ) )
{
...
i = 0;
speed = ter_op( speed <= 0, 100.0, speed );
...
damaged_model SetModel( "tag_origin" );
...
helis[ i ] SetModel( "vehicle_mi17_woodland_fly_pc" );
...
wait 0.1;
PhysicsExplosionSphere( self.origin, 768, 768, 4 );
self SetModel( "vehicle_bm21_mobile_cover_dstry_pc" );
self ThermalDrawDisable();
}
}
enemy_bm21_init()
...
b = battle_line[ 1 ] - ( m * battle_line[ 0 ] );
