...
ent thread aud_prime_stream("hamb_convoy_victim_01");
wait(4.25);
...
wait(6.3);
ent thread aud_prime_stream("hamb_convoy_victim_02");
wait(2);
...
level.sandman_free_hostage aud_prime_stream("hamb_free_hostage");
wait(2);
