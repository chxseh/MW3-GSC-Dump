...
ammo,
show_debug_draw,
abs_left, abs_right, abs_top, abs_bottom
)
{
load_fx();
load_player_anims();
...
{
player_mortar.abs_view_angle_left=abs_left;
player_mortar.abs_view_angle_right=abs_right;
}
else
{
player_mortar.abs_view_angle_left=abs_right;
player_mortar.abs_view_angle_right=abs_left;
}
player_mortar.abs_view_angle_top=abs_top;
player_mortar.abs_view_angle_bottom=abs_bottom;
...
use_stick = ( getdvar( "wii_nunchuk_aiming_turret_enabled" ) != "0" );
if ( using_wii() && !level.player using_classic_controller() && IsDefined(self.direction) && use_stick )
{
self.direction = self.direction - level.player getNormalizedMovement();
self.direction = ( AngleClamp180( self.direction[0] ), AngleClamp180( self.direction[1] ), self.direction[2] );
if (self.direction[0] < self.abs_view_angle_top)
self.direction = ( self.abs_view_angle_top, self.direction[1], self.direction[2]);
if (self.direction[0] > self.abs_view_angle_bottom)
self.direction = ( self.abs_view_angle_bottom, self.direction[1], self.direction[2]);
if (self.direction[1] < self.abs_view_angle_left)
self.direction = ( self.direction[0], self.abs_view_angle_left, self.direction[2]);
if (self.direction[1] > self.abs_view_angle_right)
self.direction = ( self.direction[0], self.abs_view_angle_right, self.direction[2]);
}
else
...
NotifyOnCommand( "mortar_fired", "+attack_akimbo_accessible" );
while ( true )
{
