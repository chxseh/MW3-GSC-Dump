...
level.player NotifyOnPlayerCommand( "jump_pressed", "+moveup" );
level.player NotifyOnPlayerCommand( "jump_pressed", "+sprint_or_jump" );
level.player NotifyOnPlayerCommand( "jump_pressed", "+zappermenu" );
...
player_spot Hide();
thread callback( "manage_player_position", player_spot );
...
player_truck_passenger gun_remove();
level.sas_leader gun_remove();
...
friend_truck_driver thread teleporty_load();
friend_truck_passenger thread teleporty_load();
friend_truck thread callback( "force_door_shut" );
level.sas_leader notify( "goal" );
friend_truck_gunner notify( "goal" );
