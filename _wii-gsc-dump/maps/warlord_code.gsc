...
level.player Shellshock( "slowview", 8);
...
aud_send_msg( "mus_river_first_encounter_all_clear" );
wait 1;
...
org notify( "stop_loop" );
civ_1_dummy wiisetallowragdoll(true);
civ_2_dummy wiisetallowragdoll(true);
foreach ( dummy in civ_dummies )
{
...
flag_set( "wii_assault_run_to_pipe" );
...
wii_assault_run_to_pipe()
{
flag_wait( "wii_assault_run_to_pipe" );
thread wii_end_warlord_a();
...
wii_end_warlord_a()
{
trig = getent ("wii_end_worlord_a", "targetname");
trig waittill ("trigger");
maps\_loadout::SavePlayerWeaponStatePersistent( "warlord_a", true );
fadeOutTime = 1;
