...
level.n_time_to_clear_breach = 11;
...
flag_wait( "belltower_intro_fade_out" );
...
level waittill("dof_change");
blend_dof( on_soap, to_outside, .5 );
to_gun= [];
to_gun[ "nearStart" ]= 0;
...
door_left_anim.angles = ( 0, 212.8, 0 );
...
door_right_anim.angles = ( 0, 32.8, 0 );
...
activate_trigger_with_targetname( "trig_price_breach_cover" );
...
{
n_time_to_clear = level.n_time_to_clear_breach;
...
{
level.player play_sound_on_entity("presc_mct_zoominyuri");
level.player play_sound_on_entity("presc_pri_allclear");
level.player play_sound_on_entity("presc_mct_makarov" );
level.player play_sound_on_entity( "presc_mkv_welcometohell" );
level.player play_sound_on_entity( "presc_mct_getouttathere" );
}
...
{
level.soap thread dialogue_queue( "presc_pri_damnit" );
}
