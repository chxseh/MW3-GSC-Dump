...
bird SetJitterParams((300, 300, 200), .25, .5);
...
bookstore_gaz = getent("uaz_01", "targetname");
bookstore_gaz delete();
}
bookstore_runners()
{
...
for(;;)
{
flag_wait("flag_dead_civ_yoga_studio");
corpses = spawn_corpses("dead_civ_yoga_studio");
flag_wait("flag_dead_civ_yoga_studio_delete");
