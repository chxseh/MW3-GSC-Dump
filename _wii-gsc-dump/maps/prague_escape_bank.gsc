...
wait(3);
level.soap dialogue_queue( "presc_mct_damnright" );
flag_wait( "vo_enemyvehicleahead" );
wait(1);
self dialogue_queue( "presc_pri_findsomewhere");
...
wait 1;
self dialogue_queue( "presc_pri_keepmoving" );
wait(1);
level.soap dialogue_queue( "presc_mct_justleaveme" );
wait(.8);
self dialogue_queue( "presc_pri_gettingyouout" );
}
trigger_suv_street()
{
