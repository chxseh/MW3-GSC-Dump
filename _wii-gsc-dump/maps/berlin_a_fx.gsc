...
thread fx_zone_watcher(1000,"msg_vfx_zone1_intro");
thread fx_zone_watcher(2000,"msg_vfx_zone2_aabuilding");
thread fx_zone_watcher(2100,"msg_vfx_zone2_aabuilding_lvl1");
thread fx_zone_watcher(2200,"msg_vfx_zone2_aabuilding_lvl2");
thread fx_zone_watcher(2250,"msg_vfx_zone2_aabuilding_lvl2_stair");
thread fx_zone_watcher(2300,"msg_vfx_zone2_aabuilding_lvl3");
thread fx_zone_watcher(2400,"msg_vfx_zone2_aabuilding_ambExplosion");
thread fx_zone_watcher(3000,"msg_vfx_zone3_cafecourtyard","msg_vfx_zone3_cafecourtyard1");
thread fx_zone_watcher(4000,"msg_vfx_zone4_riverfront");
thread fx_zone_watcher(5000,"msg_vfx_zone5_parkway","msg_vfx_zone5_parkway1");
thread fx_zone_watcher(5100,"msg_vfx_zone5_parkway_intersect");
thread fx_zone_watcher(5200,"msg_vfx_zone5_parkway_middle");
thread fx_zone_watcher(5300,"msg_vfx_zone5_parkway_rear");
thread fx_zone_watcher(7000,"msg_vfx_zone7_river_front");
thread fx_zone_watcher(10000,"msg_vfx_zone10_post_collapse");
thread fx_zone_watcher(10100,"msg_vfx_zone10_collapse_1","msg_vfx_zone10_collapse_1a");
thread fx_zone_watcher(10200,"msg_vfx_zone10_collapse_2");
thread fx_zone_watcher(10300,"msg_vfx_zone10_collapse_3");
thread fx_zone_watcher(10400,"msg_vfx_zone10_collapse_4","msg_vfx_zone10_collapse_4a");
thread fx_zone_watcher(10500,"msg_vfx_zone10_collapse_5","msg_vfx_zone10_collapse_5a");
thread fx_zone_watcher(11100,"msg_vfx_zone11_laststand_1","msg_vfx_zone11_laststand_1a");
thread fx_zone_watcher(11200,"msg_vfx_zone11_laststand_2");
thread fx_zone_watcher(11300,"msg_vfx_zone11_laststand_3");
thread fx_zone_watcher(11400,"msg_vfx_zone11_laststand_4");
thread fx_zone_watcher(11500,"msg_vfx_zone11_laststand_3","msg_vfx_zone11_laststand_4");
}
precacheFX()
{
...
helivehicletypefxend[1] = "script_vehicle_hind_woodland_streamed";
