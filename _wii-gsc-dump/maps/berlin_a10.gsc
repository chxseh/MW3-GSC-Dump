...
level.wait_time_before_strike = 2;
level.wait_time_after_strike = .5;
level.a10_confirm_second_point_wait_time = .15;
level.a10_drop_vfx_for_destroy = false;
level.a10_goggles_overlay_hi = true;
level.a10_fx_lifetime_sec = 1;
level.a10_flytime = 3;
level.a10_flyheight_increment = (0,0,512);
level.a10_fly_distance_back_increment = 512;
...
wait( level.a10_fx_lifetime_sec );
...
if(current_distance == distance_delta)
{
...
direction = level.player getgunangles();
else
...
aim_target[ "fraction" ] = trace[ "fraction" ];
if(trace_end_pos[2] > 3500)
aim_target[ "fraction" ] = 1;
aim_target["entity"] = trace["entity"];
if(level.a10_friendly_ent_target_check)
{
...
yaw = AngleClamp180( self.angles[ 1 ] );
