...
maps\sp_ny_harbor_precache::main();
maps\ny_harbor_anim::main();
maps\createart\ny_harbor_art::main();
maps\ny_harbor_fx::main();
maps\ny_harbor_aud::main();
...
sandmanSpawners = GetEntArray( "sandman_sub", "script_noteworthy" );
if( sandmanSpawners.size > 1 )
{
for( x = 1; x < sandmanSpawners.size; x++ )
{
sandmanSpawners[ x ] Delete();
}
}
}
setup_hints()
...
wait 0.05;
obj_position = level.sdv_sandman;
