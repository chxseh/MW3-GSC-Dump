...
while( !flag( "FLAG_start_chase" ) )
{
if( flag( "FLAG_start_bridge" ) )
{
return;
}
wiigeomstreamnotify( 0, 0 );
wait( 0.07 );
}
...
level_sky()
{
sky_normal = GetEnt( "sky_thermal", "targetname" );
...
level_death_fx()
{
classnames = [ "script_vehicle_t72_tank_ac130_streamed" ];
...
level.vehicle_death_fx[ "script_vehicle_t72_tank_ac130_streamed" ][ 0 ] =
maps\_vehicle::build_fx( "explosions/vehicle_explosion_t72_ac130", "tag_deathfx", undefined, undefined, undefined, undefined, 0 );
level.vehicle_death_fx[ "script_vehicle_t72_tank_ac130_streamed" ][ 1 ] =
...
for ( ;; )
{
if ( flag( "FLAG_ac130_player_in_ac130" ) && ragdoll_enabled )
{
setdvar( "ragdoll_wii_enable", false );
ragdoll_enabled = false;
}
if ( !flag( "FLAG_ac130_player_in_ac130" ) && !ragdoll_enabled )
{
setdvar( "ragdoll_wii_enable", true );
ragdoll_enabled = true;
}
wait 0.05;
}
...
mig SetModel( "vehicle_mig29_low_pc" );
...
f15 SetModel( "vehicle_mig29_low_pc" );
...
mi17 SetModel( "vehicle_mi17_woodland_fly_pc" );
...
car SetModel( "vehicle_coupe_green_destroyed" );
}
}
fdr_delta_init()
{
...
level thread lerp_fovscale_overtime( 5, 0.5 );
...
{
flag_wait( "FLAG_rpg_building_valid_target" );
addforcestreamxmodel( "building_collapse_paris_ac130_dest" );
...
thread wii_rpg_building_coverup();
...
wait 2.0;
vehicle_scripts\_ac130::ac130_set_view_arc( 2, 1.25, 1.25, 3, 20, 3, 55 );
wait 1.0;
vehicle_scripts\_ac130::playSoundOverRadio( level.scr_sound[ "snd" ][ "ac130_snd_makinhardleft" ], true, 10.0 );
wait 3.5;
...
wait 1.5;
vehicle_scripts\_ac130::ac130_set_view_arc( 2, 1.25, 1.25, 12, 25, 15, 55 );
...
vehicle_scripts\_ac130::ac130_set_view_arc( 2, 1.25, 1.25, 20, 37, 11, 55 );
...
level.ac130_vehicle delaythread( 5, ::set_VehicleSpeed, 60, 5, 5 );
wait 2.0;
...
set_VehicleSpeed( speed, accel, deccel )
{
self Vehicle_SetSpeed( speed, accel, deccel );
}
...
vehicle_scripts\_ac130::ac130_set_view_arc( 2, 1.25, 1.25, 70, 60, 17, 55 );
flag_wait( "FLAG_chase_pfr_encounter_check" );
focus MoveTo( level.chase_main_vehicle.origin, 1.25, 0.5, 0.5 );
wait 1.3;
focus LinkTo( level.chase_main_vehicle );
wait 2.0;
vehicle_scripts\_ac130::ac130_set_view_arc( 5.5, 2.5, 2.5, 15, 0, 10, 0 );
wait 5.55;
focus thread move_to_ent_over_time( level.ac130_player_view_controller_target, 1.0, ( 0, 0, 0 ), "tag_origin" );
vehicle_scripts\_ac130::ac130_set_view_arc( 2, 1.25, 1.25, 22, 30, 7, 40 );
}
...
chase_fx()
{
maps\_treadfx::setvehiclefx( "script_vehicle_hummer_streamed", "concrete", "treadfx/tread_concrete_ac130" );
maps\_treadfx::setvehiclefx( "script_vehicle_hummer_minigun_ac130_streamed", "concrete", "treadfx/tread_concrete_ac130" );
maps\_treadfx::setvehiclefx( "script_vehicle_bm21_mobile_cover_troops_streamed", "concrete", "treadfx/tread_concrete_ac130" );
maps\_treadfx::setvehiclefx( "script_vehicle_gaz_tigr_turret_physics", "concrete", "treadfx/tread_concrete_ac130" );
maps\_treadfx::setvehiclefx( "script_vehicle_hummer_streamed", "water", "treadfx/tread_water_ac130" );
maps\_treadfx::setvehiclefx( "script_vehicle_hummer_minigun_ac130_streamed", "water", "treadfx/tread_water_ac130" );
maps\_treadfx::setvehiclefx( "script_vehicle_bm21_mobile_cover_troops_streamed", "water", "treadfx/tread_water_ac130" );
maps\_treadfx::setvehiclefx( "script_vehicle_gaz_tigr_turret_physics", "water", "treadfx/tread_water_ac130" );
classnames = [ "script_vehicle_bm21_mobile_cover_troops_streamed",
...
{
spot = get_world_relative_offset( level.chase_second_vehicle.origin, level.chase_second_vehicle.angles, ( -25, -5, 100 ) ) ;
...
gunner_ent linkto ( level.chase_second_vehicle.mgturret[0], "TAG_BARREL");
}
chase_friendly_vehicle_pip_setup()
{
...
vehicle_scripts\_ac130::ac130_set_view_arc( 0, 0.05, 0.05, 20, 65, 25, 55 );
}
}
}
start_bridge()
...
wii_rpg_building_coverup()
{
wait( GetAnimLength( %ac130_building_collapse ) - 6 );
GetEnt( "rpg_building", "script_noteworthy" ) HidePart( "tag_building_base" );
}
start_chase_camhack()
{
wait ( 3 );
vehicle_scripts\_ac130::ac130_set_view_arc( 3, 1.25, 1.25, 78, 33, 15, 65 );
}