...
PreCacheModel( "ma_flatscreen_tv_wallmount_02" );
}
level_init_flags()
{
...
PreCacheRumble( "wii_hijack_plane_low");
PreCacheRumble( "wii_hijack_plane_medium");
PreCacheRumble( "wii_hijack_plane_large");
PreCacheRumble( "wii_damage_heavy" );
PreCacheRumble( "wii_hijack_heartbeat" );
...
{
light0 = GetEnt("hijack_geo_1_lights0_hjk_red_light_pulsing0", "targetname" );
light1 = GetEnt("hijack_geo_1_lights0_hjk_red_light_pulsing1", "targetname" );
light2 = GetEnt("hijack_geo_1_lights0_hjk_red_light_pulsing2", "targetname" );
light3 = GetEnt("hijack_geo_1_lights0_hjk_red_light_pulsing3", "targetname" );
