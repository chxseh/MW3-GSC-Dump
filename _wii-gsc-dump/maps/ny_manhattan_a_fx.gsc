...
level._effect["tv_ny_skyline_15broad"] = loadfx ("misc/tv_ny_skyline_15broad");
level._effect["tv_ny_downtown_15broad"] = loadfx ("misc/tv_ny_downtown_15broad");
...
level._effect[ "skybox_hind_flyby" ] = loadfx( "misc/skybox_hind_flyby_manhattan");
...
{
original_deathfx1 = level.vehicle_death_fx["script_vehicle_hind_manhattan"][5].effect;
original_deathfx2 = level.vehicle_death_fx["script_vehicle_hind_manhattan"][2].effect;
original_tag2 = level.vehicle_death_fx["script_vehicle_hind_manhattan"][2].tag;
original_looping2 = level.vehicle_death_fx["script_vehicle_hind_manhattan"][2].beffectlooping;
level.vehicle_death_fx["script_vehicle_hind_manhattan"][5].effect = getfx("ny_heli_hinddeath");
weaponname = "";
while(!flag("entering_hind"))
{
...
{
wait(2.0);
level.vehicle_death_fx["script_vehicle_hind_manhattan"][2].effect = original_deathfx2;
level.vehicle_death_fx["script_vehicle_hind_manhattan"][2].tag = original_tag2;
level.vehicle_death_fx["script_vehicle_hind_manhattan"][2].beffectlooping = original_looping2;
level notify("msg_fx_end_heliswap");
level waitframe();
}
else
{
level.vehicle_death_fx["script_vehicle_hind_manhattan"][2].effect = getfx("ny_heli_predatorexp");
level.vehicle_death_fx["script_vehicle_hind_manhattan"][2].tag = "tag_deathfx";
level.vehicle_death_fx["script_vehicle_hind_manhattan"][2].beffectlooping = 0;
atk = undefined;
level waitframe();
...
flag_wait("entering_hind");
level notify("msg_fx_end_heliswap");
level.vehicle_death_fx["script_vehicle_hind_manhattan"][5].effect = original_deathfx1;
level.vehicle_death_fx["script_vehicle_hind_manhattan"][2].effect = original_deathfx2;
level.vehicle_death_fx["script_vehicle_hind_manhattan"][2].tag = original_tag2;
level.vehicle_death_fx["script_vehicle_hind_manhattan"][2].beffectlooping = original_looping2;
}
