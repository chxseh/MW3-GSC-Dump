...
assertex(isdefined(level.sea_model),"entity with targetname=sea must be defined to use _sea");
...
{
wait .05;
sundirection = getmapsundirection();
SetSunDirection( sundirection );
level.lite_settings = vectortoangles(sundirection);
...
self.ang = ( org.rotation * self.scale );
}
sea_objectbob( org )
{
