...
light = get_target_ent( "partition_129_sewer_intro_light" );
...
if ( notetrack == "ps_scn_prague_swim_slow_npc" || notetrack == "end" )
...
if ( notetrack == "ps_scn_prague_swim_idle_npc" || notetrack == "end" )
