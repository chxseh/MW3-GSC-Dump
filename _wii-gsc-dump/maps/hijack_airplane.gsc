...
level.polit_1 gun_remove();
level.polit_2 gun_remove();
level.intro_origin = getstruct("pres_room_struct" , "targetname");
aud_send_msg("debate");
waittillframeend;
level.commander gun_remove();
...
level.player PlayRumbleOnEntity( "wii_hijack_plane_low" );
}
...
rig = spawn( "script_origin", level.player.origin);
...
level.intro_origin thread anim_single_solo( level.commander, "debate", undefined, .04);
...
level.player PlayRumbleOnEntity( "wii_hijack_plane_medium" );
...
level.intro_origin thread anim_single_solo( level.conf_phone_1, "debate_phone1_lurch" );
...
{
light1 = getEnt( "hijack_geo_1_lights0_conf_room_spot1", "targetname" );
light2 = getEnt( "hijack_geo_1_lights0_conf_room_spot2", "targetname" );
...
temp_ent MoveTo( (-28436, 12728, level.player.origin[2]), .25, 0, .1 );
}
...
tv_ent = GetEnt("debate_tv", "script_noteworthy");
tv_ent SetModel("ma_flatscreen_tv_wallmount_02");
...
thread precache_zerog_anims();
flag_wait("prezerog_extra_guys");
extra_guy = spawn_targetname( "pre_zerog_terrorist_wave2" );
level.pre_zerog_guys = get_living_ai_array( "pre_zerog_terrorists" , "script_noteworthy" );
}
precache_zerog_anims()
{
zerog_origin = getstruct( "all_plane_origin", "targetname" );
zerog_player_rig = spawn_anim_model( "test_body", zerog_origin.origin );
zerog_origin thread anim_first_frame_solo(zerog_player_rig, "zero_g_player" );
rig1 = spawn_anim_model( "zerog_terror1_track" );
zerog_origin thread anim_first_frame_solo( rig1, "zerog_terrorist_01_align" );
rig2 = spawn_anim_model( "zerog_terror2_track" );
zerog_origin thread anim_first_frame_solo( rig2, "zerog_terrorist_02_align" );
rig3 = spawn_anim_model( "zerog_terror3_track" );
zerog_origin thread anim_first_frame_solo( rig3, "zerog_terrorist_03_align" );
rig4 = spawn_anim_model( "zerog_terror4_track" );
zerog_origin thread anim_first_frame_solo( rig4, "zerog_terrorist_04_align" );
rig5 = spawn_anim_model( "zerog_terror5_track" );
zerog_origin thread anim_first_frame_solo( rig5, "zerog_terrorist_05_align" );
flag_wait( "zero_g_trig" );
wait 1.0;
zerog_player_rig Delete();
rig1 Delete();
rig2 Delete();
rig3 Delete();
rig4 Delete();
...
{
self thread zerog_kill( self.anim_1 );
}
self waittill( "death" );
}
#using_animtree( "generic_human" );
...
if ( index > -1 )
{
level.destructible_type[ index ].parts[ 0 ][ 0 ].v[ "fx_filename" ][ 0 ][ 0 ] = "maps/hijack/luggage_1_des_hjk";
level.destructible_type[ index ].parts[ 0 ][ 0 ].v[ "fx" ][ 0 ][ 0 ] = getfx("luggage_1_des");
}
index = common_scripts\_destructible_types::getInfoIndex( "toy_luggage_02" );
if ( index > -1 )
{
level.destructible_type[ index ].parts[ 0 ][ 0 ].v[ "fx_filename" ][ 0 ][ 0 ] = "maps/hijack/luggage_2_des_hjk";
level.destructible_type[ index ].parts[ 0 ][ 0 ].v[ "fx" ][ 0 ][ 0 ] = getfx("luggage_2_des");
}
index = common_scripts\_destructible_types::getInfoIndex( "toy_luggage_03" );
if ( index > -1 )
{
level.destructible_type[ index ].parts[ 0 ][ 0 ].v[ "fx_filename" ][ 0 ][ 0 ] = "maps/hijack/luggage_3_des_hjk";
level.destructible_type[ index ].parts[ 0 ][ 0 ].v[ "fx" ][ 0 ][ 0 ] = getfx("luggage_3_des");
}
index = common_scripts\_destructible_types::getInfoIndex( "toy_luggage_04" );
if ( index > -1 )
{
level.destructible_type[ index ].parts[ 0 ][ 0 ].v[ "fx_filename" ][ 0 ][ 0 ] = "maps/hijack/luggage_4_des_hjk";
level.destructible_type[ index ].parts[ 0 ][ 0 ].v[ "fx" ][ 0 ][ 0 ] = getfx("luggage_4_des");
}
}
...
zerog_firsthit(guy)
{
level.player PlayRumbleOnEntity( "wii_hijack_plane_large" );
level.player DisableWeapons();
...
setPhysicsGravityDir( (0.00, -0.01, 0.01) );
}
zerog_bigshake(guy)
{
...
{
level.commander dialogue_queue("hijack_cmd_roomclear");
}
...
cargo_room_terrorists_b = array_spawn_targetname("cargo_room_terrorists_b");
