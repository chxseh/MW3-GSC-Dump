...
PreCacheModel( "foliage_intro_tree_01_destroyed_stream" );
...
PreCacheRumble( "wii_heli_rumble" );
PreCacheRumble( "wii_artillery_rumble" );
PreCacheRumble( "wii_light_1s" );
maps\_wii_utility::wii_precache_random_heavy_rumbles();
...
struct.rumble = "wii_heli_rumble";
struct.rumble_rate_wii = 0.1;
level.vehicle_rumble[ "script_vehicle_mi28_flying" ] = struct;
level.vehicle_rumble[ "script_vehicle_mi17_woodland_fly" ] = struct;
...
maars_control()
{
thread maars_control_monitor_background_hillside_visibility();
