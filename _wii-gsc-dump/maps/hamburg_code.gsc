...
GetEnt( "parking_garage_ramps5_garage_crash_light_flicker", "targetname" ) SetLightIntensity( 0 );
}
...
array_thread( GetEntArray( "script_vehicle_apache_mg_streamed", "classname" ), ::add_spawn_function_if_is_spawner, ::apaches_stuff );
...
wait 1;
delaythread( 1.1, ::garage_cleanup_beach_area );
}
...
{
if ( !isSubStr( target.script_soundalias, "_player_" ) || Distance( level.player.origin, self.origin ) < 800 )
{
