...
wires = thread wires_wind_med(wires);
...
{
bush_anim_name = "strong_sway_" + randomintrange(1,3);
...
{
fence_anim_name = "strong_sway_" + randomintrange(1,3);
...
foreach(tarp in tarp03_array)
{
tarp_anim_name = "strong_sway_" + randomintrange(1,3);
