...
thread geo_fog_fx();
thread fx_zone_watcher(1000,"msg_fx_zone1000");
thread fx_zone_watcher(1500,"msg_fx_zone1000","msg_fx_zone1500");
thread fx_zone_watcher(2000,"msg_fx_zone2000");
thread fx_zone_watcher(3000,"msg_fx_zone3000");
thread fx_zone_watcher(4000,"msg_fx_zone4000");
thread fx_zone_watcher(5000,"msg_fx_zone5000","msg_fx_zone5000","off_flag");
thread fx_zone_watcher(15050,"msg_fx_zone15050");
...
level._effect[ "dubai_water_fountain_splash_single" ] = loadfx( "maps/dubai/dubai_water_fountain_splash_single" );
...
level._effect[ "price_reflection" ] = loadfx( "maps/dubai/price_reflection" );
level._effect[ "makarov_head_slam_1" ] = loadfx( "maps/dubai/makarov_head_glass_impact" );
level._effect[ "makarov_head_slam_2" ] = loadfx( "maps/dubai/makarov_head_glass_impact_2" );
level._effect[ "makarov_head_slam_3" ] = loadfx( "maps/dubai/makarov_head_glass_impact" );
...
thread restaurant_floor_tilt_ground_fire_vfx();
...
{
delaythread (.3, ::exploder, 10008);
delaythread (3.8, ::exploder, 10009);
delaythread (.15, ::exploder, 10006);
wait 5.0;
kill_exploder(10006);
}
...
playfxontag(getfx("suburban_strobe_centered_r"),strobetag_r,"tag_origin");
wait(.35);
playfxontag(getfx("suburban_strobe_centered_l"),strobetag_l,"tag_origin");
self waittill("death");
self vehicle_lights_off("combined");
stopfxontag(getfx("suburban_strobe_centered_r"),strobetag_r,"tag_origin");
...
{
light = GetEnt( "burj_al_arab_top_grand_floor_rooftop3_rooftop_searchlight_key", "targetname" );
if( !isdefined( light ) )
{
...
light = GetEnt( "burj_al_arab_top_grand_floor_side_left59_mysterious_stranger_rimlight", "targetname" );
if( !isdefined( light ) )
{
...
{
light = GetEnt( "burj_al_arab_top_grand_floor2_atrium_fire_light_key", "targetname" );
if( !isdefined( light ) )
{
...
{
fxents = get_exploder_entarray( 20004 );
...
fxents = get_exploder_entarray( 20005 );
foreach( ent in fxents )
{
parent_ent = spawn_tag_origin();
parent_ent.origin = ent.v[ "origin" ];
...
{
wait 3.0;
player_contents = level.player SetContents( 0 );
MagicBullet( "nosound_magicbullet", ( 889, -79, 8110 ), ( 889, -79, 7900 ) , level.player );
level.player SetContents( player_contents );
wait 1.0;
exploder(22003);
wait(2.0);
exploder(22003);
