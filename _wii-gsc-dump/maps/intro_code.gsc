...
intro_shot_6()
{
spot_cinema = GetEnt( "intro_geo0_spot_cinema", "targetname" );
...
level.player delaycall( 4.75, ::playrumbleonentity, "damage_heavy" );
level.nikolai thread multiple_dialogue_queue( "intro_opening_shot07_face" );
thread intro_shot_7_to_8_transition_effect();
anim_pos anim_single_end_early( actors, "intro_opening_shot07" );
}
intro_shot_7_to_8_transition_effect()
{
wait 9.0;
fx_origin = spawn_tag_origin();
fx_origin linkto(level.player_rig, "tag_player", (0, 0, 60), (0, 0, 90));
playfxontag(getfx("heli_crash_wall_dust"), fx_origin, "tag_origin");
}
intro_shot_8()
{
...
earthquake(.8, 3, org.origin, 1024);
level.player playrumbleonentity( "wii_artillery_rumble" );
...
spawners[0] courtyard_mi17_drone();
wait( 6 );
...
self FireWeapon( "tag_flash", entTarget );
wait( delay );
...
{
anim_pos = GetStruct( "anim_intro_room", "targetname" );
level.doctor stop_magic_bullet_shield( );
...
array_spawn_noteworthy( "regroup_intro_friendlies_init_extra" );
}
...
delaythread( 4, ::maars_control_garage_door_open, rolling_door );
...
maars_control_garage_door_open(door_anim_model)
{
...
if( IsDefined( door_anim_model ) )
{
door_anim_model NotSolid();
}
}
...
newMissile thread fire_fake_missile_earthquake( self );
...
maps\_wii_utility::wii_play_random_heavy_rumble(2.25);
level.player delaycall( 8.5, ::playrumbleonentity, "wii_artillery_rumble" );
level.player delaycall( 19.5, ::playrumbleonentity, "wii_artillery_rumble" );
delaythread( 5, ::autosave_by_name_silent, "building_slide" );
thread building_slide_defrag_streaming();
...
building_slide_defrag_streaming()
{
wait 7;
AddForceStreamXModel("intro_landslide_small_01");
AddForceStreamXModel("intro_landslide_small_02");
level.player ForceStreamerDefrag();
wait 13;
RemoveForceStreamXModel("intro_landslide_small_01");
RemoveForceStreamXModel("intro_landslide_small_02");
}
...
level.player delaycall( 6, ::playrumbleonentity, "wii_artillery_rumble" );
level.player delaycall( 9, ::playrumbleonentity, "wii_light_1s" );
maps\_wii_utility::wii_play_random_heavy_rumble(2.25, 13);
...
{
setsaveddvar("cg_cinematicFullScreen", "0");
cinematicingame( cinematicName, 1 );
...
{
door = node get_target_ent();
nodeoffset = AnglesToForward( node.angles ) * - 32;
