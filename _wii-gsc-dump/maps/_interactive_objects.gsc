...
{
level._glass_info = [];
level._glass_info[ "glass_xlarge" ][ "breakfx" ] = loadfx( "explosions/window_exp_glass_breakable_xlg" );
level._glass_info[ "glass_xlarge" ][ "breaksnd" ] = "veh_glass_break_large";
level._glass_info[ "glass_large" ][ "breakfx" ] = loadfx( "explosions/window_exp_glass_breakable_lg" );
...
{
if ( isSP() && self.remove.spawnflags & DYNAMICPATH )
...
direction_vec = ( direction_vec * 0.5 + RandomFloat( 1 ) );
self notify( "death" );
