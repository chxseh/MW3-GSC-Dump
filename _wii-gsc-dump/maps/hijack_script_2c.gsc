...
level.chopper_land_node thread anim_loop_solo(level.president, "end_part1", "stop_part_1" );
...
level.commander forceUseWeapon( level.commander.sidearm, "sidearm" );
