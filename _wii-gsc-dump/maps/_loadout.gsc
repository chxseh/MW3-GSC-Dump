...
else if ( loadout_name == "paris_ac130" || loadout_name == "paris_ac130_a" || loadout_name == "paris_ac130_b" )
{
level.player SetViewmodel( "viewhands_delta" );
...
else if ( loadout_name == "prague_escape_end")
{
level.player GiveWeapon( "deserteagle" );
level.player GiveWeapon( "m4m203_reflex" );
level.player GiveWeapon( "fraggrenade" );
...
so_body_player_delta() { if (is_specialop()) self setModel( "mp_body_delta_elite_assault_bb_s" ); else self setModel( "mp_body_delta_elite_assault_bb" ); self attach( "head_delta_elite_a", "", true ); }
...
so_body_player_delta_precache() { if (is_specialop()) precachemodel( "mp_body_delta_elite_assault_bb_s" ); else precachemodel( "mp_body_delta_elite_assault_bb" );precachemodel( "head_delta_elite_a" ); }
