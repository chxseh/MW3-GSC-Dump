...
radio_add( "hamburg_snd_t90rightside" );
radio_dialogue_interupt("hamburg_snd_t90rightside");
tank_out_of_left = get_vehicle( "tank_out_of_left", "script_noteworthy" ) godoff();
flag_wait( "hind_hind" );
radio_add( "hamburg_rhg_hind" );
radio_dialogue_overlap("hamburg_rhg_hind" );
