...
PreCacheModel( "vehicle_80s_hatch1_green_destroyed" );
}
start_s2_city()
{
...
interrogation_origin = getent( "reference_waraabe_breach", "targetname" );
interrogation_exit_door_reference = spawn_anim_model( "dummy_prop_6" );
interrogation_origin anim_first_frame_solo( interrogation_exit_door_reference , "waraabe_interrogation" );
interrogation_exit_door = Spawn( "script_model", interrogation_origin.origin );
interrogation_exit_door SetModel( "pb_door_breach" );
interrogation_exit_door LinkTo( interrogation_exit_door_reference, "J_prop_1" , ( 0, 0, 0 ), ( 0, 0, 0 ) );
level.start_point = "s2_city";
...
thread start_s2_city_dialogue();
streets();
}
start_s2_city_dialogue()
{
...
aud_send_msg("city_ambush_04_mayhem");
wait 0.5;
...
thread array_spawn_targetname("streets_area1_runners1");
wait 2;
...
thread maps\payback_aud::delete_chopper_audio();
}
...
car SetModel( "vehicle_80s_hatch1_green_destroyed" );
...
tech = spawn_vehicle_from_targetname_and_drive( "streets_tech_1" );
tech godon();
...
flag_set ( "streets_area3_start_mainpath" );
wait 2;
