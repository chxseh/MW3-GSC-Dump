...
aud_launch_level_threads()
{
if (!IsDefined(level.aud.launch_level_threads))
{
...
music_cue("mus_intro");
level.player thread aud_prime_stream("warl_intro_player_emerge_start");
wait(2.5);
...
{
MUS_play("warl_take_them_out", 10.0);
}
break;
...
MUS_play("warl_tire_burning_all_clear", 10.0);
}
break;
...
{
thread play_sound_in_space("mortar_impact_3d", hit_pos);
thread play_sound_in_space("player_3d_mortar",hit_pos);
thread play_sound_in_space("player_mortar_debris",hit_pos);
wait(0.2);
thread play_sound_in_space("player_mortar_debris_lyr",hit_pos);
}
else if(!IsDefined(level.aud.mortar_run_complete))
{
thread play_sound_in_space("npc_mortar_lfe", hit_pos);
thread play_sound_in_space("mortar_run_impact_2d", hit_pos);
thread play_sound_in_space("npc_2d_mortar",hit_pos);
thread play_sound_in_space("npc_mortar_debris_lyr",hit_pos);
wait(0.08);
thread play_sound_in_space("mortar_impact_ring", hit_pos);
wait(0.2);
thread play_sound_in_space("npc_mortar_debris",hit_pos);
}
else
{
thread play_sound_in_space("mortar_run_impact_3d", hit_pos);
thread play_sound_in_space("npc_3d_mortar",hit_pos);
thread play_sound_in_space("npc_mortar_debris_lyr",hit_pos);
wait(0.08);
thread play_sound_in_space("mortar_impact_ring", hit_pos);
wait(0.2);
...
aud_start_loops()
{
loop_fx_sound("warl_wind_heavy_lp", (3876, 2546, 800),	true);
loop_fx_sound("warl_wind_heavy_lp", (7198, 5314, -208),	true);
loop_fx_sound("warl_wind_heavy_lp", (6470, 7111, 1500),	true);
loop_fx_sound("warl_wind_med_lp", (6508, 8932, 632),	true);
loop_fx_sound("warl_wind_med_lp", (6118, 8511, 699),	true);
loop_fx_sound("warl_dog_in_house_lp",	(6878, 8346, 626),	true);
loop_fx_sound("warl_water_pipe_drips",(6444, 8368, 576), true);
loop_fx_sound("warl_water_pipe_drips",(6250, 8530, 576), true);
loop_fx_sound("warl_water_pipe_drips",(6027, 8718, 576), true);
loop_fx_sound("warl_water_pipe_outflow",(5883, 8853, 536), true);
loop_fx_sound("warl_water_pipe_outflow",(5636, 9261, 468), true);
}
aud_start_positional_dambs()
{
...
aud_start_fire_dambs()
{
DAMB_start_preset_at_point("fire_warlord_piles", (1208, -600, -47), "pre_hyena_01", 600, 1.0);
DAMB_start_preset_at_point("fire_warlord_piles_sml", (946, -2, -42), "post_hyena_01", 600, 1.0);
DAMB_start_preset_at_point("fire_warlord_piles_sml", (883, 221, -50), "post_hyena_02", 600, 1.0);
DAMB_start_preset_at_point("fire_warlord_piles_sml", (789, 305, -27), "post_hyena_03", 600, 1.0);
DAMB_start_preset_at_point("fire_warlord_piles_sml", (689, 237, -39), "post_hyena_04", 600, 1.0);
DAMB_start_preset_at_point("fire_warlord_piles_sml", (798, -350, -50), "post_hyena_05", 600, 1.0);
DAMB_start_preset_at_point("fire_warlord_piles_sml", (612, -339, -47), "post_hyena_06", 600, 1.0);
DAMB_start_preset_at_point("fire_warlord_piles_sml", (541, -288, -35), "post_hyena_07", 600, 1.0);
DAMB_start_preset_at_point("fire_warlord_piles_sml", (465, -136, -38), "post_hyena_08", 600, 1.0);
DAMB_start_preset_at_point("fire_warlord_piles_sml", (320, -61, -21), "post_hyena_09", 600, 1.0);
DAMB_start_preset_at_point("fire_warlord_piles", (391, 82, -22), "post_hyena_10", 600, 1.0);
DAMB_start_preset_at_point("fire_warlord_piles_sml", (431, 124, -30), "post_hyena_11", 600, 1.0);
DAMB_start_preset_at_point("fire_warlord_piles_sml", (396, 156, 48), "post_hyena_12", 600, 1.0);
DAMB_start_preset_at_point("fire_warlord_piles_sml", (249, 213, 64), "post_hyena_13", 600, 1.0);
DAMB_start_preset_at_point("fire_warlord_piles_sml", (351, 297, 59), "post_hyena_14", 600, 1.0);
DAMB_start_preset_at_point("fire_warlord_piles_sml", (52, 401, 2), "post_hyena_15", 600, 1.0);
}
...
wait(0.05);
MM_scale_submix("warl_swamp_footsteps_shallow", 0, 0);
...
wait(0.05);
MM_scale_submix("warl_swamp_npc_footsteps_shallow", 0, 0);
level endon("aud_warl_stop_monitor_footsteps");
...
thread aud_warl_stop_river_rain_drops(rain_drops, 15);
}
...
mi17_dummy thread aud_kill_1st_heli();
