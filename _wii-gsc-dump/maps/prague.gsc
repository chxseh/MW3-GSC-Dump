...
start_sewers()
{
thread maps\_utility::set_ambient("prague_sewer");
...
wait( 0.1 );
lights_flick = getentarray( "sewer42_sewer_light_primary", "targetname" );
...
thread flickering_light( get_target_ent( "combo_building_f32_alley_alcove_light" ), 0.5, 0.75 );
