...
level.player thread aud_prime_stream("bln_intro_flight_javelin_explo_01");
javelin waittill("death");
...
level.player thread aud_prime_stream("bln_intro_flight_javelin_explo_02");
javelin waittill("death");
...
level.player aud_prime_and_play_on_plr("bln_intro_flight_deadbird_impact", 2.4);
}
break;
case "deadbird_crash":
{
...
sam_site playsound("explo_move_mixed_01");
}
break;
...
lead_heli = heli_array[1];
rear_heli = heli_array[3];
...
min_speed = 1;
max_speed = 3;
tank_ent.shellshock_audio_disabled = true;
tank_ent thread aud_ally_tank_fire_watch();
...
{
level.player thread aud_prime_and_play_on_plr("building_collapse_chunk_wsh",2.45, true);
}
break;
...
{
loop_fx_sound("berl_fire_heatcreaks_lp", (2493, 2640, 35),1);
DAMB_start_preset_at_point("fire_metal_med", (2493, 2640, 35), "littlebird_metal_01", 600, 1.0);
DAMB_start_preset_at_point("fire_wood_med", (2493, 2640, 35), "littlebird_wide_spread_01", 600, 1.0);
DAMB_start_preset_at_point("fire_crackle_med", (2535, 2620, 22), "littlebird_wide_spread_crackle", 600, 1.0);
DAMB_start_preset_at_point("fire_wood_med_tight", (2249, 2801, 16), "littlebird_crackle_18", 700, 1.0);
}
aud_start_collapse_fires()
{
DAMB_start_preset_at_point("fire_wood_med_tight", (30715, 4294, 263), "collapse_entrance_left", 600, 1.0);
DAMB_start_preset_at_point("fire_wood_med_tight", (30656, 4333, 247), "collapse_entrance_leftmid", 600, 1.0);
DAMB_start_preset_at_point("fire_wood_med_tight", (30707, 4498, 276), "collapse_entrance_rightmid", 600, 1.0);
DAMB_start_preset_at_point("fire_crackle_med", (30741, 4549, 294), "collapse_entrance_right", 600, 1.0);
DAMB_start_preset_at_point("fire_metal_med", (31724, 5164, 180), "collapse_tank", 600, 1.0);
DAMB_start_preset_at_point("fire_wood_med_tight", (30301, 5750, 403), "pre_emerge_left", 600, 1.0);
DAMB_start_preset_at_point("fire_wood_med_tight", (30273, 5849, 399), "pre_emerge_right", 600, 1.0);
DAMB_start_preset_at_point("fire_crackle_med", (30156, 5779, 401), "pre_emerge_center", 600, 1.0);
loop_fx_sound("berl_emt_firejet", (31156, 5409, 310),1);
DAMB_start_preset_at_point("fire_gas_med_tight", (31156, 5409, 310), "jet_01", 600, 1.0);
loop_fx_sound("berl_emt_firejet", (30634, 6078, 319),1);
DAMB_start_preset_at_point("fire_gas_med_tight", (30634, 6078, 319), "jet_02", 600, 1.0);
}
aud_start_level_fires()
{
DAMB_start_preset_at_point("fire_metal_med", (2772, 1408, 12), "car_metal_01", 600, 1.0);
DAMB_start_preset_at_point("fire_metal_med", (30718, 7159, 83), "car_metal_02", 600, 1.0);
DAMB_start_preset_at_point("fire_wood_med_tight", (29800, 7610, 158), "burning_tree", 600, 1.0);
DAMB_start_preset_at_point("fire_wood_med", (30077, 7517, 386), "hotel_lobby_L", 600, 1.0);
DAMB_start_preset_at_point("fire_wood_med", (30239, 7361, 438), "hotel_lobby_R", 600, 1.0);
DAMB_start_preset_at_point("fire_wood_med_tight", (30809, 8582, 225), "hotel_lobby_farwall", 600, 1.0);
DAMB_start_preset_at_point("fire_wood_med_tight", (29906, 8194, 649), "hotel_dresser", 600, 1.0);
DAMB_start_preset_at_point("fire_wood_med_tight", (29997, 8037, 686), "hotel_wall", 600, 1.0);
DAMB_start_preset_at_point("fire_wood_med_tight", (29849, 7789, 613), "hotel_chair", 600, 1.0);
DAMB_start_preset_at_point("fire_rock_sml", (30128, 8422, 587), "hotel_trashcan", 600, 1.0);
}
aud_start_water()
{
loop_fx_sound("berlin_emt_water_drips",(1700,5363,1052),1);
loop_fx_sound("berlin_emt_water_drips",(1566,4743,1051),1);
loop_fx_sound("berlin_emt_water_drips_collapse",(30137,4572,256),1);
loop_fx_sound("berlin_emt_bathroom_drips",(29938,4578,376),1);
loop_fx_sound("berlin_emt_water_drips_collapse",(31077,5045,240),1);
loop_fx_sound("berlin_emt_water_pipe_spray_ground",(1574,4717,1052),1);
loop_fx_sound("berlin_emt_faucet_spray_splatter",(1574,4717,1052),1);
loop_fx_sound("berlin_emt_bathroom_drips",(30805,5072,332),1);
loop_fx_sound("berlin_emt_water_splatter_large",(30828,4965,256),1);
loop_fx_sound("berlin_emt_faucet_spray_splatter",(30828,4965,256),1);
loop_fx_sound("berlin_emt_bathroom_sinkleak",(30971,5080,303),1);
loop_fx_sound("berlin_emt_faucet_spray",(30763,4882,266),1);
loop_fx_sound("berlin_emt_water_drips_bathroom",(30660,5023,280),1);
loop_fx_sound("berlin_emt_water_drips_bathroom",(30793,4922,269),1);
loop_fx_sound("berlin_emt_water_drips_bathroom",(30797,5041,251),1);
loop_fx_sound("berlin_emt_water_drips_bathroom",(30761,5278,298),1);
loop_fx_sound("berlin_emt_toilet_flooding",(30937,5009,254),1);
loop_fx_sound("berlin_emt_drain",(30824,5194,240),1);
loop_fx_sound("berlin_emt_water_drips_collapse",(30465,4474,150),1);
loop_fx_sound("berlin_emt_water_drips_collapse",(30428,4335,171),1);
loop_fx_sound("berlin_emt_water_drips_collapse",(31004,5002,271),1);
}
aud_start_wind()
{
loop_fx_sound("blin_wind_heavy_lp", (1019, 5627, 1000), 1);
loop_fx_sound("blin_wind_heavy_lp", (1831, 3891, 1400), 1);
}
aud_start_hotel_tv()
{
...
{
self waittill("weapon_fired");
self thread aud_ally_tank_shock_check();
...
player_dist = distance(level.player.origin, self.origin);
...
aud_ent = spawn("script_origin", level.player.origin);
aud_ent thread aud_prime_stream("bln_rvrs_breach_getup_foley_start");
