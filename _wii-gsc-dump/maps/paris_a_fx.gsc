...
thread fx_zone_watcher(1100,"msg_fx_zone1100");
thread fx_zone_watcher(1110,"msg_fx_zone1110");
thread fx_zone_watcher(1200,"msg_fx_zone1200","msg_fx_zone1210");
thread fx_zone_watcher(2000,"msg_fx_zone2000");
thread fx_zone_watcher(2500,"msg_fx_zone2500");
thread fx_zone_watcher(3000,"msg_fx_zone3000");
thread fx_zone_watcher(3500,"msg_fx_zone3500","msg_fx_zone3600");
thread fx_zone_watcher(4000,"msg_fx_zone4000");
thread fx_zone_watcher(5000,"msg_fx_zone5000");
...
if (flag("enable_distant_bombShakes"))
{
...
helivehicletypefx[0] = "script_vehicle_littlebird_bench_paris_a";
...
maps\_treadfx::setvehiclefx( helivehicletype, "water", fx );
