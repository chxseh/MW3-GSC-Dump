...
agent1.lastGroundtype = "snow";
agent2.lastGroundtype = "snow";
...
{
anim_origin = GetStruct("post_crash_scene_origin","targetname");
cab2_med_door1 = GetEnt("cab2_med_door1","targetname");
cab2_med_door2 = GetEnt("cab2_med_door2","targetname");
cab2_lg_door1 = GetEnt("cab2_lg_door1","targetname");
cab2_lg_door2 = GetEnt("cab2_lg_door2","targetname");
cab1_sm_door1 = GetEnt("cab1_sm_door1","targetname");
cab1_sm_door2 = GetEnt("cab1_sm_door2","targetname");
cab1_sm_door3 = GetEnt("cab1_sm_door3","targetname");
cab1_sm_door4 = GetEnt("cab1_sm_door4","targetname");
cab1_med_door1 = GetEnt("cab1_med_door1","targetname");
cab1_med_door2 = GetEnt("cab1_med_door2","targetname");
cab1_med_door3 = GetEnt("cab1_med_door3","targetname");
cab1_med_door4 = GetEnt("cab1_med_door4","targetname");
cab1_med_door5 = GetEnt("cab1_med_door5","targetname");
cab1_med_door6 = GetEnt("cab1_med_door6","targetname");
cab1_med_door7 = GetEnt("cab1_med_door7","targetname");
cab1_med_door8 = GetEnt("cab1_med_door8","targetname");
cab1_lg_door1 = GetEnt("cab1_lg_door1","targetname");
cab1_drawer1 = GetEnt("cab1_drawer1","targetname");
cab1_drawer2 = GetEnt("cab1_drawer2","targetname");
cab3_med_door1 = GetEnt("cab3_med_door1","targetname");
cab3_med_door2 = GetEnt("cab3_med_door2","targetname");
cab3_med_door3 = GetEnt("cab3_med_door3","targetname");
cab3_med_door4 = GetEnt("cab3_med_door4","targetname");
ladder = GetEnt("post_crash_airplane_ladder","targetname");
floor_chunk = GetEnt("post_crash_airplane_floor_chunk","targetname");
tire = GetEnt("post_crash_airplane_tire","targetname");
crate = GetEnt("post_crash_airplane_crate","targetname");
crate2 = GetEnt("post_crash_airplane_crate_2","targetname");
pipe_small = GetEnt("post_crash_pipe_small","targetname");
pipe_large = GetEnt("post_crash_pipe_large","targetname");
...
while(1)
{
flag_wait("player_inside_plane_wreck");
thread maps\_blizzard_hijack::blizzard_level_transition_none( 1 );
flag_waitopen("player_inside_plane_wreck");
...
{
FSO_agents[0] = spawn_targetname( "FSO_idlers_0" );
FSO_agents[1] = spawn_targetname( "FSO_idlers_1" );
FSO_agents[2] = spawn_targetname( "FSO_idlers_2" );
...
FSO_engine_react()
{
FSO_agents[0] = spawn_targetname( "FSO_engine_react_0" );
FSO_agents[1] = spawn_targetname( "FSO_engine_react_1" );
FSO_agents[2] = spawn_targetname( "FSO_engine_react_2" );
FSO_agents[0] thread cold_breath_hijack();
FSO_agents[1] thread cold_breath_hijack();
FSO_agents[2] thread cold_breath_hijack();
...
{
FSO_agents[0] = spawn_targetname( "FSO_tail_react_0" );
FSO_agents[1] = spawn_targetname( "FSO_tail_react_1" );
...
FSO_agents[1] = spawn_targetname( "FSO_trapped_agent_1" );
