...
level.player thread aud_prime_stream ("harb_single_missile_overhead");
wait(0.5);
...
{
torpedo_1 = args;
level.player thread aud_prime_stream("oscar_torpedoes_st");
wait(0.9);
...
{
thread play_loopsound_in_space("sub_emt_waterfall_pipe",(-36285,-24116,-230));
thread play_loopsound_in_space("sub_emt_waterfall_splatter_large",(-36287,-24102,-417));
...
{
missile = args;
thread aud_prime_and_play("russian_sub_missile_launch", 1, missile.origin);
wait(1);
aud_stop_city_combat_ambi();
}
break;
...
{
projectile = spawn("script_origin", missile.origin);
projectile thread aud_prime_stream("missile_boat_travel_2");
wait(1.0);
projectile linkto( missile );
...
if(IsDefined(missile))
{
level.player aud_prime_and_play_on_plr("missile_boat_incoming", 2.8);
}
}
break;
...
{
level.player PlaySound( "missile_boat_explo");
level.player PlaySound( "missile_boat_explo_metal");
}
...
level.player playsound("boat_slowmo_fireball");
...
level.player thread aud_prime_stream ("boat_slowmo_end");
wait(1.1);
...
{
thread aud_prime_and_play("chinook_flyby_rears", 2, level.player.origin);
}
break;
...
level.player thread aud_prime_stream("zodoac_to_chinook_splash");
wait(1.0);
...
thread aud_prime_and_play("chinook_liftoff_fronts", 3.4, level.player.origin);
}
break;
case "spawn_f15_fighters_finale":
{
level.player thread aud_prime_stream ("f15_final_flyby_fronts");
wait(2.3);
...
case "fx_skybox_mig":
{
if (!flag("aud_flag_inside_sub") && !flag("player_on_boat") && flag("player_through_water"))
{
start_point	= args[0];
end_point = args[1];
flight_time	= args[2];
...
if (level.aud.mig_count < MAX_VFX_MIGS && yards < 1000000)
{
level.aud.mig_count++;
...
{
aud_prime_city_combat_ambi();
while ( !(level.aud.city_amb_ent_L aud_is_stream_primed("amb_harb_dist_city_combat_L")))
{
wait(0.05);
}
}
...
{
level.player playsound("harb_battleship_sink_splashes");
}
...
inc_ent thread aud_prime_stream("harb_surface_missile_incoming_ext");
level.player thread aud_prime_stream("harb_surface_missile_overhead");
wait(0.3);
...
aud_start_subtop_line_emitters()
{
thread aud_play_line_emitter("sub_waves_right", "sub_surfaced_side_water_close_l", (-40261,-24354,-130), (-35223,-24524,-130), 1.0, 2.0);
thread aud_play_line_emitter("sub_waves_left", "sub_surfaced_side_water_close_r", (-40254,-23394,-130), (-35165,-23366,-130), 1.0, 2.0);
...
aud_machinery_emitters()
{
loop_fx_sound("sub_emt_engine_turbine_01",(-39342, -23987, -396),1);
loop_fx_sound("sub_emt_engine_turbine_02",(-39308, -23722, -360),1);
loop_fx_sound("sub_emt_turbine_diesel_01",(-39342, -23987, -396),1);
loop_fx_sound("sub_emt_turbine_diesel_02",(-39308, -23722, -360),1);
}
aud_electric_breakerboxes()
{
loop_fx_sound("sub_emt_electric_hum", (-37693, -23667, -414),1);
...
loop_fx_sound("sub_emt_comp_large_on",(-35825,-23642,-240),1);
}
aud_floodroom_water()
{
loop_fx_sound("harb_emt_water_flooding_large_lp",(-38532,-24093,-574),1);
...
{
wait(1);
siren_01 = Spawn("script_origin",(-38895,-23724,-360));
siren_01 PlayLoopSound("sub_emt_small_alarm_01_intro");
wait(0.1);
siren_01 scalevolume(0.0, 0.05);
siren_01_occluded = Spawn( "script_origin", (-38895,-23724,-360));
...
scuttle_alarm_01 PlayLoopSound("sub_emt_alarm_01_tight");
scuttle_alarm_02 = Spawn("script_origin", (-37207,-23853,-192));
scuttle_alarm_02 PlayLoopSound("sub_emt_large_alarm_01");
scuttle_alarm_03 = Spawn("script_origin", (-36470,-23856,-192));
scuttle_alarm_03 PlayLoopSound("sub_emt_alarm_01_reactor");
...
aud_sub_waterfalls()
{
loop_fx_sound("sub_emt_waterfall_splatter_large",(-37052,-23603,-422),1);
loop_fx_sound("sub_emt_waterfall_splatter_large",(-36126,-23685,-431),1);
loop_fx_sound("sub_emt_waterfall_splatter_small",(-36147,-23610,-423),1);
loop_fx_sound("sub_emt_waterfall_splatter_large",(-36619,-24058,-434),1);
loop_fx_sound("sub_emt_waterfall_splatter_large",(-36048,-23886,-439),1);
loop_fx_sound("sub_emt_waterfall_pipe",(-36622,-24035,-242),1);
loop_fx_sound("sub_emt_waterfall_pipe",(-36112,-23656,-242),1);
loop_fx_sound("sub_emt_waterfall_pipe",(-36143,-23578,-241),1);
}
aud_controlroom_radios()
{
loop_fx_sound("sub_emt_rus_radio_01",(-35548,-24070,-245),1);
loop_fx_sound("sub_emt_rus_radio_02",(-35500,-23653,-250),1);
loop_fx_sound("sub_emt_rus_radio_02",(-35805,-23652,-250),1);
}
aud_fires()
{
loop_fx_sound("harb_emt_fire_metal_large",(-38541,-23707,-520));
loop_fx_sound("harb_emt_fire_metal_small",(-39485,-23872,-400),1);
loop_fx_sound("harb_emt_fire_metal_small",(-39397,-23885,-400),1);
loop_fx_sound("harb_emt_fire_metal_small",(-39465,-23809,-400),1);
loop_fx_sound("harb_emt_fire_electrical_small",(-35506,-23630,-224),1);
...
aud_velocity_emitters()
{
loop_fx_sound("peer_velo_whoosh",(-22365,-18856,-171),1);
loop_fx_sound("peer_velo_whoosh",(-22581,-19179,-171),1);
loop_fx_sound("peer_velo_whoosh",(-21995,-19050,-171),1);
loop_fx_sound("peer_velo_whoosh",(-22208,-19422,-171),1);
loop_fx_sound("peer_velo_whoosh",(-21775,-19481,-171),1);
loop_fx_sound("peer_velo_whoosh",(-21300,-19519,-171),1);
loop_fx_sound("peer_velo_whoosh",(-20937,-19757,-171),1);
loop_fx_sound("peer_velo_whoosh",(-20548,-20024,-171),1);
loop_fx_sound("peer_velo_whoosh",(-20209,-20237,-171),1);
loop_fx_sound("peer_velo_whoosh",(-19859,-20482,-171),1);
}
...
level.player thread aud_prime_stream("cannonball_water_splats_2d");
wait(0.6);
level.player playsound("cannonball_water_splats_2d");
}
...
{
wait (5);
level.player thread aud_prime_stream("harb_sub_explosion_front");
wait (5);
...
level.player thread aud_prime_stream("zodoac_to_chinook_impact");
wait(0.7);
level.player playsound("zodoac_to_chinook_impact");
thread AZM_start_zone("nyhb_chinook_interior_flight", 1.5);
thread aud_prime_and_play ("zodoac_to_chinook_slide", 1.45, level.player.origin );
wait(3);
...
if (p2l_dot_l2r > 0 && p2r_dot_l2r > 0)
{
sound_origin = left_prop_origin;
}
else if (p2l_dot_l2r < 0 && p2r_dot_l2r < 0)
{
...
level.player aud_prime_stream ("sub_surface_breach_fronts");
wait(7.4);
...
wait(0.5);
ent playsound("sub_scuttle_explosion");
