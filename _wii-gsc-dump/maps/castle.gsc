...
PreCacheRumble( "wii_damage_light" );
PreCacheRumble( "wii_subtle_tank_rumble" );
...
ent.sunEndFadeAngle = 95;
set_fog_ent(ent, 1 );
flag_wait("castle_bridge_explosion_fog");
ent = get_fog_ent("castle_exterior");
