...
kill_entrance_flare()
{
light = get_target_ent( "sewer42_entrance_flare_primary" );
...
{
self.fxtag = "tag_front_light_right";
light = get_Target_ent( "prague_script0_btr_primary_light" );
...
if ( ( d.damageyaw > 135 ) || ( d.damageyaw <= -135 ) )
{
dir = "b";
}
else if ( ( d.damageyaw > 45 ) && ( d.damageyaw <= 135 ) )
{
dir = "l";
}
else if ( ( d.damageyaw > - 45 ) && ( d.damageyaw <= 45 ) )
{
dir = "f";
}
else
...
vignette_btr_think()
{
self build_rumble_unique( "wii_subtle_tank_rumble", 0.2, 4.5, 192, 1, 1 );
self.rumbleon = true;
self endon( "death" );
self waittill( "move" );
self thread gopath();
...
CONST_searchlight_move_speed	= 1;
...
self wii_play_rumble_loop_on_entity( rumblestruct.rumble );
...
{
node = a maps\_stealth_shared_utilities::enemy_find_free_pathnode_near( org, 300, 40 );
a notify( "ai_event", "grenade danger", grenade );
if ( isdefined( node ) )
{
