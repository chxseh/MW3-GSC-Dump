...
{
ease_in_speed = gt_op( ease_in_speed, 0.05 );
ease_out_speed	= gt_op( ease_out_speed, 0.05 );
lookat_time = gt_op( lookat_time, 0 );
angles = ( 0, self GetTagAngles( "j_head" )[ 1 ], 0 );
...
level.pip.width = 64;
level.pip.height = 64;
level.pip.visionsetnaked = "paris_ac130_night";
