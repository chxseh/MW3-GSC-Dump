...
positions[ "right" ].origin = origin + ( right * 40 ) + ( forward * 30 );
positions[ "left" ].origin = origin + ( right * -40 ) + ( forward * 30 );
positions[ "back_right" ].origin	= origin + ( right * 32 ) + ( forward * -16 );
positions[ "back_left" ].origin = origin + ( right * -32 ) + ( forward * -16 );
positions[ "back" ].origin = origin + ( forward * -48 );
