...
jeep_flare_light = GetEnt( "payback_geo_3a_lights5_jeep_flare" , "targetname" );
...
level.soap dialogue_queue( "payback_mct_theresnikschopper" );
aud_send_msg("mus_rescue_start_nikolai_music");
wait .2;
level.price dialogue_queue( "payback_pri_echoteampinned" );
wait .2;
level.price dialogue_queue( "payback_pri_fromnorthwest" );
wait .1;
radio_dialogue( "payback_eol_copythat" );
...
level.price dialogue_queue( "payback_pri_goodtoseeyou" );
wait .5;
level.rescue_echo_1 dialogue_queue( "payback_eol_twovehicles" );
trigger_on( "ready_to_pick_up_niko_save_trig" , "targetname" );
wait .5;
level.price dialogue_queue( "payback_pri_suppress" );
wait 4;
while ( 1 )
{
level.price dialogue_queue( "payback_pri_getnikolai" );
wait 4;
level.price dialogue_queue( "payback_pri_grabnikolai" );
wait 4;
level.price dialogue_queue( "payback_pri_waitingfor" );
wait 4;
}
}
health_mods()
...
{
wait .5;
level.price dialogue_queue( "payback_pri_headingtoexfil" );
}
...
level.price dialogue_queue( "payback_pri_moveout4" );
wait 2;
level.soap dialogue_queue( "payback_mct_followme" );
wait 2;
level.price dialogue_queue( "payback_pri_comeonyuri" );
flag_wait( "start_flare" );
SetCullDist(0);
wait 1;
level.soap dialogue_queue( "payback_mct_iseethem" );
wait 2;
level.price dialogue_queue( "payback_pri_yurithisway" );
wait 2;
level.soap dialogue_queue( "payback_mct_keepmoving2" );
wait 2;
level.price dialogue_queue( "payback_pri_letsgoyuri" );
}
pickup_nikolai_and_escape_radio_vo()
{
level.player endon( "death" );
wait 3;
level.rescue_echo_1 dialogue_queue( "payback_eol_approachingexfil" );
flag_wait( "start_flare" );
wait 2;
if( IsDefined( level.rescue_echo_1 ) && IsAlive( level.rescue_echo_1 ) )
{
level.rescue_echo_1 dialogue_queue( "payback_eol_letsgo" );
}
}
