...
turret = self;
turret endon( "death" );
turret endon( "disable_turret" );
turret makeunusable();
turret setdefaultdroppitch(0);
while(1)
{
wait(1.5);
self.usable_turret_trigger = self spawn_tag_origin();
self.usable_turret_trigger makeUsable();
self.usable_turret_trigger setHintString( &"PLATFORM_HOLD_TO_USE" );
self.usable_turret_trigger waittill( "trigger" );
...
if ( isdefined( self.usable_turret_trigger ) )
self.usable_turret_trigger delete();
}
