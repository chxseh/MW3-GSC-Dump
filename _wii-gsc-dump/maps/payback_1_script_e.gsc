...
level.price dialogue_queue( "payback_pri_doortooffice" );
wait .5;
trigger_on( "breach_save_trig_1" , "targetname" );
level.price dialogue_queue( "payback_pri_needhimalive2" );
...
aud_send_msg("mus_door_breached");
wait .1;
...
{
maps\_loadout::SavePlayerWeaponStatePersistent( "payback_a", true );
fadeOutTime = 1;
...
swap_model(model)
{
level.price SetModel("body_price_africe_wii");
...
{
level endon( "death" );
aud_send_msg("gasmask_on_player");
...
{
level endon( "death" );
aud_send_msg("gasmask_off_player");
level.player DisableWeaponSwitch();
level.player DisableUsability();
level.player DisableOffhandWeapons();
wait(.25);
