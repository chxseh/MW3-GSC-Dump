...
character\character_gign_paris_gasmask_hero::main();
}
spawner()
{
...
precache()
{
character\character_gign_paris_gasmask_hero::precache();
precacheItem("g36c");
...
{
models = [];
models = codescripts\character::array_append(models,character\character_gign_paris_gasmask_hero::enumerate_xmodels());
