...
character\character_so_juggernaut_explosive_s::main();
}
spawner()
{
...
precache()
{
character\character_so_juggernaut_explosive_s::precache();
...
{
models = [];
models = codescripts\character::array_append(models,character\character_so_juggernaut_explosive_s::enumerate_xmodels());
